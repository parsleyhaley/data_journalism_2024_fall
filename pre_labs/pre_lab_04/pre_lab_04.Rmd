...
**Answer**
Lots of inconsistencies in case and the use of terms/symbols, like "&" vs "and". Also, full or partial titles-- so, names like "walter's sports bar" being shortened to "walter's sports" --so even though they are the same restaurant, the names don't match.
...
**Answer**
The refinr package changed case for SCARLET OAK to Scarlet Oak. I don't see any other changes. 
...
**Answer**For the name "W. Millar & Co." (and its variations that appear in the recipient_name category) refinr made the name of the resturant all caps and added a period after "CO" (although refinr kept the word "CATERING" for the original entries that were "W. Willar & Co. Catering" or some variation on that title). For the same name, refinr changed the word "company" to "co.", transforming "W.Millar & Company Catering" to "W. MILLAR & CO. CATERING." 
...
**Answer**
No, the changes do not vary substantially. 
